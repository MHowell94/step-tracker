...
@Observable class HealthKitManager {
    ...
    /// Fetch most recent sample on each day for a specified number of days back from today.
    /// - Parameter daysBack: Days back from today. Example: 28 will return the last 28 days.
    ...
    /// Write count data to HealthKit. Requires HealthKit write permission.
    /// - Parameters:
    ...
    /// - Parameters:
    ///   - date: End of date interval. Example: Today
    ///   - daysBack: Start of date interval. Example: 28 days ago
